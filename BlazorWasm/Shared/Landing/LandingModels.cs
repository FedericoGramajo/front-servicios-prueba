...
public record ServiceModel(string Name, string Description, string Category, string ImageUrl, decimal Price);
public record ProfessionalModel(string Name, string Specialty, string City, string ImageUrl, double Rating, int Projects);
